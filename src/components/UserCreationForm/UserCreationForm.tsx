            ...
            <form onSubmit={handleSubmit(handleOnSubmit)}>
                ...
                <Stack direction={"column"} fullWidth spacing={4}>
                    <Controller
                        name={"firstName"}
                        control={control}
                        render={({field}) => <TextField fullWidth label={"Prénom"} {...field}  />}
                    />

                    <Controller
                        name={"lastName"}
                        control={control}
                        render={({field}) => <TextField fullWidth label={"Nom"} {...field}  />}
                    />
                ...
                <Stack direction={"row"} justifyContent={"flex-end"} spacing={3} fullWidth>
                    <Button variant={"primary"} style={"outline"} onPress={handleOnCancel}>Annuler</Button>
                    <Button type={"submit"} variant={"primary"} style={"fill"}>Ajouter</Button>
                </Stack>
                </Stack>
